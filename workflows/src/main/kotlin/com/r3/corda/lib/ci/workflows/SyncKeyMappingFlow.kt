...
) : Flow<Unit>, CustomProgressTracker {
...
class SyncKeyMappingFlowHandler(private val otherSession: FlowSession) : Flow<Unit>, CustomProgressTracker {
    companion object {
